...
using System;
namespace GitHub.Octokit.Versions {
    /// <summary>
...
#nullable enable
        public async Task<List<Date?>?> GetAsync(Action<VersionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Date?>> GetAsync(Action<VersionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
