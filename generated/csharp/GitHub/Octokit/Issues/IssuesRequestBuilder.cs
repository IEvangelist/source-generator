...
namespace GitHub.Octokit.Issues {
    ...
    public class IssuesRequestBuilder : BaseRequestBuilder {
        ...
        public IssuesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/issues{?filter*,state*,labels*,sort*,direction*,since*,collab*,orgs*,owned*,pulls*,per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IssuesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IssuesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/issues{?filter*,state*,labels*,sort*,direction*,since*,collab*,orgs*,owned*,pulls*,per_page*,page*}", rawUrl) {
        }
        /// <summary>
