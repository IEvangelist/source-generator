...
using System;
namespace GitHub.Octokit.Organizations {
    /// <summary>
...
#nullable enable
        public async Task<List<OrganizationSimple>?> GetAsync(Action<OrganizationsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<OrganizationSimple>> GetAsync(Action<OrganizationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
