// <auto-generated/>
using GitHub.Octokit.Codes_of_conduct.Item;
...
using System;
namespace GitHub.Octokit.Codes_of_conduct {
    /// <summary>
    ...
    public class Codes_of_conductRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.codes_of_conduct.item collection</summary>
...
#nullable enable
        public async Task<List<CodeOfConduct>?> GetAsync(Action<Codes_of_conductRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<CodeOfConduct>> GetAsync(Action<Codes_of_conductRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<Codes_of_conductRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<Codes_of_conductRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new Codes_of_conductRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public class Codes_of_conductRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new codes_of_conductRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public Codes_of_conductRequestBuilderGetRequestConfiguration() {
