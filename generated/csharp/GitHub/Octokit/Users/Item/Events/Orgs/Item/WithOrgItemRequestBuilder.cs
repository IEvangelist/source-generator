...
using System;
namespace GitHub.Octokit.Users.Item.Events.Orgs.Item {
    /// <summary>
...
#nullable enable
        public async Task<List<Event>?> GetAsync(Action<WithOrgItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Event>> GetAsync(Action<WithOrgItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public class WithOrgItemRequestBuilderGetRequestConfiguration {
            ...
            public WithOrgItemRequestBuilderGetQueryParameters QueryParameters { get; set; } = new WithOrgItemRequestBuilderGetQueryParameters();
            /// <summary>
