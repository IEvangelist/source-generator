...
using System;
namespace GitHub.Octokit.Users.Item.Keys {
    /// <summary>
...
#nullable enable
        public async Task<List<KeySimple>?> GetAsync(Action<KeysRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<KeySimple>> GetAsync(Action<KeysRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
