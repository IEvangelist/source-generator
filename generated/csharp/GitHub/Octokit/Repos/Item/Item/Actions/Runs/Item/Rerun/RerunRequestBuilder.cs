...
namespace GitHub.Octokit.Repos.Item.Item.Actions.Runs.Item.Rerun {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\actions\runs\{run_id}\rerun
    /// </summary>
    public class RerunRequestBuilder : BaseRequestBuilder {
        ...
        public RerunRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/actions/runs/{run_id}/rerun", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RerunRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RerunRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/actions/runs/{run_id}/rerun", rawUrl) {
        }
        /// <summary>
