...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Actions.Runs.Item.Timing {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\actions\runs\{run_id}\timing
    /// </summary>
    public class TimingRequestBuilder : BaseRequestBuilder {
        ...
        public TimingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/actions/runs/{run_id}/timing", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TimingRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/actions/runs/{run_id}/timing", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WorkflowRunUsage?> GetAsync(Action<TimingRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkflowRunUsage> GetAsync(Action<TimingRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
