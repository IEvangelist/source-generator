// <auto-generated/>
using GitHub.Octokit.Repos.Item.Item.Codespaces.Secrets.Item;
using GitHub.Octokit.Repos.Item.Item.Codespaces.Secrets.PublicKey;
...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Codespaces.Secrets {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\codespaces\secrets
    /// </summary>
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the GitHub.Octokit.repos.item.item.codespaces.secrets.item collection</summary>
        ...
        public SecretsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/codespaces/secrets{?per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecretsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecretsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/codespaces/secrets{?per_page*,page*}", rawUrl) {
        }
        /// <summary>
