...
#nullable restore
        ...
        public async Task<WithPathResponse> GetAsync(Action<WithPathItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<WithPathResponse>(requestInfo, WithPathResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Models.ContentFile? ContentFile { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Models.ContentFile ContentFile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Models.ContentSubmodule? ContentSubmodule { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Models.ContentSubmodule ContentSubmodule { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Models.ContentSymlink? ContentSymlink { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Models.ContentSymlink ContentSymlink { get; set; }
#endif
...
#nullable restore
            ...
            public static WithPathGetResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("content-file".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.ContentFile = new GitHub.Octokit.Models.ContentFile();
                }
                else if("content-submodule".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.ContentSubmodule = new GitHub.Octokit.Models.ContentSubmodule();
                }
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(ContentFile != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Models.ContentFile>(null, ContentFile);
                }
                else if(ContentSubmodule != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Models.ContentSubmodule>(null, ContentSubmodule);
                }
                else if(ContentSymlink != null) {
