...
using System;
namespace GitHub.Octokit.Repos.Item.Item.SecurityAdvisories.Item.Forks {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\security-advisories\{ghsa_id}\forks
    /// </summary>
    public class ForksRequestBuilder : BaseRequestBuilder {
        ...
        public ForksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/security-advisories/{ghsa_id}/forks", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ForksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ForksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/security-advisories/{ghsa_id}/forks", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<FullRepository?> PostAsync(Action<ForksRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<FullRepository> PostAsync(Action<ForksRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
