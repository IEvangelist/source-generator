...
namespace GitHub.Octokit.Repos.Item.Item.Issues {
    ...
    public class IssuesRequestBuilder : BaseRequestBuilder {
        ...
        public IssuesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/issues{?milestone*,state*,assignee*,creator*,mentioned*,labels*,sort*,direction*,since*,per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new IssuesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IssuesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/issues{?milestone*,state*,assignee*,creator*,mentioned*,labels*,sort*,direction*,since*,per_page*,page*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<Issue>?> GetAsync(Action<IssuesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Issue>> GetAsync(Action<IssuesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Issue?> PostAsync(IssuesPostRequestBody body, Action<IssuesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Issue> PostAsync(IssuesPostRequestBody body, Action<IssuesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(IssuesPostRequestBody body, Action<IssuesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(IssuesPostRequestBody body, Action<IssuesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
