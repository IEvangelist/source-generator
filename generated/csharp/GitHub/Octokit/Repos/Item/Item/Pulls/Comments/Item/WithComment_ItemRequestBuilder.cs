...
using GitHub.Octokit.Repos.Item.Item.Pulls.Comments.Item.Reactions;
...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Pulls.Comments.Item {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\pulls\comments\{comment_id}
    /// </summary>
    public class WithComment_ItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithComment_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/pulls/comments/{comment_id}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithComment_ItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithComment_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/pulls/comments/{comment_id}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PullRequestReviewComment?> GetAsync(Action<WithComment_ItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PullRequestReviewComment> GetAsync(Action<WithComment_ItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PullRequestReviewComment?> PatchAsync(WithComment_PatchRequestBody body, Action<WithComment_ItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PullRequestReviewComment> PatchAsync(WithComment_PatchRequestBody body, Action<WithComment_ItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
