...
using GitHub.Octokit.Repos.Item.Item.Pulls.Item.Reviews.Item.Comments;
using GitHub.Octokit.Repos.Item.Item.Pulls.Item.Reviews.Item.Dismissals;
using GitHub.Octokit.Repos.Item.Item.Pulls.Item.Reviews.Item.Events;
...
namespace GitHub.Octokit.Repos.Item.Item.Pulls.Item.Reviews.Item {
    ...
    public class WithReview_ItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithReview_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithReview_ItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithReview_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}", rawUrl) {
        }
        /// <summary>
