...
namespace GitHub.Octokit.Repos.Item.Item.Activity {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\activity
    /// </summary>
    public class ActivityRequestBuilder : BaseRequestBuilder {
        ...
        public ActivityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/activity{?direction*,per_page*,before*,after*,ref*,actor*,time_period*,activity_type*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ActivityRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ActivityRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/activity{?direction*,per_page*,before*,after*,ref*,actor*,time_period*,activity_type*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<GitHub.Octokit.Models.Activity>?> GetAsync(Action<ActivityRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<GitHub.Octokit.Models.Activity>> GetAsync(Action<ActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<GitHub.Octokit.Models.Activity>(requestInfo, GitHub.Octokit.Models.Activity.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        public class ActivityRequestBuilderGetQueryParameters {
            ...
            [Obsolete("This property is deprecated, use activity_typeAsGetActivity_typeQueryParameterType instead")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <summary>The activity type to filter by.For example, you can choose to filter by &quot;force_push&quot;, to see all force pushes to the repository.</summary>
            [QueryParameter("activity_type")]
            public GetActivity_typeQueryParameterType? ActivityTypeAsGetActivityTypeQueryParameterType { get; set; }
