...
using GitHub.Octokit.Repos.Item.Item.Releases.Assets;
using GitHub.Octokit.Repos.Item.Item.Releases.GenerateNotes;
using GitHub.Octokit.Repos.Item.Item.Releases.Item;
using GitHub.Octokit.Repos.Item.Item.Releases.Latest;
using GitHub.Octokit.Repos.Item.Item.Releases.Tags;
...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Releases {
    /// <summary>
    ...
    public class ReleasesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the GitHub.Octokit.repos.item.item.releases.item collection</summary>
        ...
        public WithRelease_ItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
