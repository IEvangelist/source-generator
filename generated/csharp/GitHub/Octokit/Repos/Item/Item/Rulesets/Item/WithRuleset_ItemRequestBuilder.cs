...
namespace GitHub.Octokit.Repos.Item.Item.Rulesets.Item {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\rulesets\{ruleset_id}
    /// </summary>
    public class WithRuleset_ItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithRuleset_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/rulesets/{ruleset_id}{?includes_parents*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithRuleset_ItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRuleset_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/rulesets/{ruleset_id}{?includes_parents*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class WithRuleset_ItemRequestBuilderGetRequestConfiguration {
            ...
            public WithRuleset_ItemRequestBuilderGetQueryParameters QueryParameters { get; set; } = new WithRuleset_ItemRequestBuilderGetQueryParameters();
            /// <summary>
