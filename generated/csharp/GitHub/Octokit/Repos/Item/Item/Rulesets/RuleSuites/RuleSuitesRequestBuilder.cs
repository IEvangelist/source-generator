...
using GitHub.Octokit.Repos.Item.Item.Rulesets.RuleSuites.Item;
...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Rulesets.RuleSuites {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\rulesets\rule-suites
    /// </summary>
    public class RuleSuitesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.repos.item.item.rulesets.ruleSuites.item collection</summary>
        ...
        public RuleSuitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/rulesets/rule-suites{?ref*,time_period*,actor_name*,rule_suite_result*,per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RuleSuitesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RuleSuitesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/rulesets/rule-suites{?ref*,time_period*,actor_name*,rule_suite_result*,per_page*,page*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<GitHub.Octokit.Models.RuleSuites>?> GetAsync(Action<RuleSuitesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<GitHub.Octokit.Models.RuleSuites>> GetAsync(Action<RuleSuitesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<GitHub.Octokit.Models.RuleSuites>(requestInfo, GitHub.Octokit.Models.RuleSuites.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RuleSuitesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RuleSuitesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RuleSuitesRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class RuleSuitesRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public RuleSuitesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new RuleSuitesRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new ruleSuitesRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public RuleSuitesRequestBuilderGetRequestConfiguration() {
