...
using GitHub.Octokit.Repos.Item.Item.CodeScanning.Analyses.Item;
...
namespace GitHub.Octokit.Repos.Item.Item.CodeScanning.Analyses {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\code-scanning\analyses
    /// </summary>
    public class AnalysesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.repos.item.item.codeScanning.analyses.item collection</summary>
        ...
        public WithAnalysis_ItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("analysis_id", position);
            return new WithAnalysis_ItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public AnalysesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/code-scanning/analyses{?tool_name*,tool_guid*,page*,per_page*,ref*,sarif_id*,direction*,sort*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnalysesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AnalysesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/code-scanning/analyses{?tool_name*,tool_guid*,page*,per_page*,ref*,sarif_id*,direction*,sort*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<CodeScanningAnalysis>?> GetAsync(Action<AnalysesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<CodeScanningAnalysis>> GetAsync(Action<AnalysesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<AnalysesRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<AnalysesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new AnalysesRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class AnalysesRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public AnalysesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new AnalysesRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new analysesRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public AnalysesRequestBuilderGetRequestConfiguration() {
