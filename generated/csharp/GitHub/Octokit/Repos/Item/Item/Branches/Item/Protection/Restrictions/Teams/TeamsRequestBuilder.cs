...
using System;
namespace GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams {
    /// <summary>
    /// Builds and executes requests for operations under \repos\{owner}\{repo}\branches\{branch}\protection\restrictions\teams
    /// </summary>
    public class TeamsRequestBuilder : BaseRequestBuilder {
        ...
        public TeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TeamsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<Team>?> DeleteAsync(TeamsDeleteRequestBody body, Action<TeamsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Team>> DeleteAsync(TeamsDeleteRequestBody body, Action<TeamsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<Team>?> PostAsync(TeamsPostRequestBody body, Action<TeamsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Team>> PostAsync(TeamsPostRequestBody body, Action<TeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<Team>?> PutAsync(TeamsPutRequestBody body, Action<TeamsRequestBuilderPutRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Team>> PutAsync(TeamsPutRequestBody body, Action<TeamsRequestBuilderPutRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(TeamsDeleteRequestBody body, Action<TeamsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(TeamsDeleteRequestBody body, Action<TeamsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new TeamsRequestBuilderDeleteRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(TeamsPutRequestBody body, Action<TeamsRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(TeamsPutRequestBody body, Action<TeamsRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new TeamsRequestBuilderPutRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1? TeamsDeleteRequestBodyMember1 { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1 TeamsDeleteRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1? TeamsDeleteRequestBodyTeamsDeleteRequestBodyMember1 { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1 TeamsDeleteRequestBodyTeamsDeleteRequestBodyMember1 { get; set; }
#endif
            ...
            public static TeamsDeleteRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.TeamsDeleteRequestBodyMember1 = new GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.TeamsDeleteRequestBodyTeamsDeleteRequestBodyMember1 = new GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1();
                }
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                ...
                if(TeamsDeleteRequestBodyMember1 != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1>(null, TeamsDeleteRequestBodyMember1);
                }
                else if(TeamsDeleteRequestBodyTeamsDeleteRequestBodyMember1 != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsDeleteRequestBodyMember1>(null, TeamsDeleteRequestBodyTeamsDeleteRequestBodyMember1);
                }
                else if(String != null) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1? TeamsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1 TeamsPostRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1? TeamsPostRequestBodyTeamsPostRequestBodyMember1 { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1 TeamsPostRequestBodyTeamsPostRequestBodyMember1 { get; set; }
#endif
            ...
            public static TeamsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.TeamsPostRequestBodyMember1 = new GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.TeamsPostRequestBodyTeamsPostRequestBodyMember1 = new GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1();
                }
                else if(parseNode.GetStringValue() is string stringValue) {
                    result.String = stringValue;
                }
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                _ = writer ?? throw new ArgumentNullException(nameof(writer));
                if(TeamsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1>(null, TeamsPostRequestBodyMember1);
                }
                else if(TeamsPostRequestBodyTeamsPostRequestBodyMember1 != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPostRequestBodyMember1>(null, TeamsPostRequestBodyTeamsPostRequestBodyMember1);
                }
                else if(String != null) {
                    writer.WriteStringValue(null, String);
                }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1? TeamsPutRequestBodyMember1 { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1 TeamsPutRequestBodyMember1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1? TeamsPutRequestBodyTeamsPutRequestBodyMember1 { get; set; }
#nullable restore
#else
            public GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1 TeamsPutRequestBodyTeamsPutRequestBodyMember1 { get; set; }
#endif
            ...
            public static TeamsPutRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.TeamsPutRequestBodyMember1 = new GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1();
                }
                else if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.TeamsPutRequestBodyTeamsPutRequestBodyMember1 = new GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1();
                }
                else if(parseNode.GetStringValue() is string stringValue) {
                    result.String = stringValue;
                }
            ...
            public virtual void Serialize(ISerializationWriter writer) {
                _ = writer ?? throw new ArgumentNullException(nameof(writer));
                if(TeamsPutRequestBodyMember1 != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1>(null, TeamsPutRequestBodyMember1);
                }
                else if(TeamsPutRequestBodyTeamsPutRequestBodyMember1 != null) {
                    writer.WriteObjectValue<GitHub.Octokit.Repos.Item.Item.Branches.Item.Protection.Restrictions.Teams.TeamsPutRequestBodyMember1>(null, TeamsPutRequestBodyTeamsPutRequestBodyMember1);
                }
                else if(String != null) {
                    writer.WriteStringValue(null, String);
                }
        ...
        /// </summary>
        public class TeamsRequestBuilderDeleteRequestConfiguration {
            ...
            /// </summary>
            public TeamsRequestBuilderDeleteRequestConfiguration() {
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class TeamsRequestBuilderPutRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new teamsRequestBuilderPutRequestConfiguration and sets the default values.
            /// </summary>
            public TeamsRequestBuilderPutRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
