// <auto-generated/>
using GitHub.Octokit.Classrooms.Item.Assignments;
...
using System;
namespace GitHub.Octokit.Classrooms.Item {
    /// <summary>
...
#nullable enable
        public async Task<Classroom?> GetAsync(Action<WithClassroom_ItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Classroom> GetAsync(Action<WithClassroom_ItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<WithClassroom_ItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<WithClassroom_ItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new WithClassroom_ItemRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public class WithClassroom_ItemRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new WithClassroom_ItemRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public WithClassroom_ItemRequestBuilderGetRequestConfiguration() {
