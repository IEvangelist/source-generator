...
using System;
namespace GitHub.Octokit.Classrooms.Item.Assignments {
    /// <summary>
...
#nullable enable
        public async Task<List<SimpleClassroomAssignment>?> GetAsync(Action<AssignmentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<SimpleClassroomAssignment>> GetAsync(Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
