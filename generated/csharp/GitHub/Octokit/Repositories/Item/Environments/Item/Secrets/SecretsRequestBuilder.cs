// <auto-generated/>
using GitHub.Octokit.Repositories.Item.Environments.Item.Secrets.Item;
using GitHub.Octokit.Repositories.Item.Environments.Item.Secrets.PublicKey;
...
namespace GitHub.Octokit.Repositories.Item.Environments.Item.Secrets {
    /// <summary>
    /// Builds and executes requests for operations under \repositories\{repository_id}\environments\{environment_name}\secrets
    /// </summary>
    public class SecretsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the GitHub.Octokit.repositories.item.environments.item.secrets.item collection</summary>
        ...
        public SecretsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repositories/{repository_id}/environments/{environment_name}/secrets{?per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecretsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecretsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repositories/{repository_id}/environments/{environment_name}/secrets{?per_page*,page*}", rawUrl) {
        }
        /// <summary>
