...
using System;
namespace GitHub.Octokit.Applications.Item.Token.Scoped {
    /// <summary>
...
#nullable enable
        public async Task<Authorization?> PostAsync(ScopedPostRequestBody body, Action<ScopedRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Authorization> PostAsync(ScopedPostRequestBody body, Action<ScopedRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ScopedPostRequestBody body, Action<ScopedRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ScopedPostRequestBody body, Action<ScopedRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ScopedRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class ScopedRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new scopedRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public ScopedRequestBuilderPostRequestConfiguration() {
