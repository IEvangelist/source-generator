...
using GitHub.Octokit.Projects.Item.Collaborators.Item;
...
namespace GitHub.Octokit.Projects.Item.Collaborators {
    ...
    public class CollaboratorsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.projects.item.collaborators.item collection</summary>
...
#nullable enable
        public async Task<List<SimpleUser>?> GetAsync(Action<CollaboratorsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<SimpleUser>> GetAsync(Action<CollaboratorsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
