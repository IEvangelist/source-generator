...
using GitHub.Octokit.User.Packages.Item.Item.Restore;
using GitHub.Octokit.User.Packages.Item.Item.Versions;
...
using System;
namespace GitHub.Octokit.User.Packages.Item.Item {
    /// <summary>
