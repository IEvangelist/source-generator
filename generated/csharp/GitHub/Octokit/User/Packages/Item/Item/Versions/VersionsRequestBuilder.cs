...
using GitHub.Octokit.User.Packages.Item.Item.Versions.Item;
...
namespace GitHub.Octokit.User.Packages.Item.Item.Versions {
    ...
    public class VersionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.user.packages.item.item.versions.item collection</summary>
