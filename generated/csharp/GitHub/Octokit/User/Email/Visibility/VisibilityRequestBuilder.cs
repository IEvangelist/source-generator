...
#nullable enable
        public async Task<List<GitHub.Octokit.Models.Email>?> PatchAsync(VisibilityPatchRequestBody body, Action<VisibilityRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<GitHub.Octokit.Models.Email>> PatchAsync(VisibilityPatchRequestBody body, Action<VisibilityRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(VisibilityPatchRequestBody body, Action<VisibilityRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(VisibilityPatchRequestBody body, Action<VisibilityRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new VisibilityRequestBuilderPatchRequestConfiguration();
        ...
        /// </summary>
        public class VisibilityRequestBuilderPatchRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new visibilityRequestBuilderPatchRequestConfiguration and sets the default values.
            /// </summary>
            public VisibilityRequestBuilderPatchRequestConfiguration() {
