...
using System;
namespace GitHub.Octokit.User.Codespaces.Secrets.PublicKey {
    /// <summary>
...
#nullable enable
        public async Task<CodespacesUserPublicKey?> GetAsync(Action<PublicKeyRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CodespacesUserPublicKey> GetAsync(Action<PublicKeyRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
