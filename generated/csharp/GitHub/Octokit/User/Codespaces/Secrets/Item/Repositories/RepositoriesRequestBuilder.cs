...
using GitHub.Octokit.User.Codespaces.Secrets.Item.Repositories.Item;
...
namespace GitHub.Octokit.User.Codespaces.Secrets.Item.Repositories {
    ...
    public class RepositoriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.user.codespaces.secrets.item.repositories.item collection</summary>
