...
using System;
namespace GitHub.Octokit.User.Codespaces.Item.Publish {
    /// <summary>
...
#nullable enable
        public async Task<CodespaceWithFullRepository?> PostAsync(PublishPostRequestBody body, Action<PublishRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CodespaceWithFullRepository> PostAsync(PublishPostRequestBody body, Action<PublishRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
