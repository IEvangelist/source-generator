...
using System;
namespace GitHub.Octokit.User.Codespaces.Item.Start {
    /// <summary>
...
#nullable enable
        public async Task<Codespace?> PostAsync(Action<StartRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Codespace> PostAsync(Action<StartRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                ...
                {"402", BasicError.CreateFromDiscriminatorValue},
