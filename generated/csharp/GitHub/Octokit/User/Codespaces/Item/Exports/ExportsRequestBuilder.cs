...
using GitHub.Octokit.User.Codespaces.Item.Exports.Item;
...
using System;
namespace GitHub.Octokit.User.Codespaces.Item.Exports {
    /// <summary>
    ...
    public class ExportsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.user.codespaces.item.exports.item collection</summary>
...
#nullable enable
        public async Task<CodespaceExportDetails?> PostAsync(Action<ExportsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CodespaceExportDetails> PostAsync(Action<ExportsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<ExportsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<ExportsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ExportsRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class ExportsRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new exportsRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public ExportsRequestBuilderPostRequestConfiguration() {
