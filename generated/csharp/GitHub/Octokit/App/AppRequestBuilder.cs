// <auto-generated/>
using GitHub.Octokit.App.Hook;
using GitHub.Octokit.App.InstallationRequests;
using GitHub.Octokit.App.Installations;
...
#nullable enable
        public async Task<Integration?> GetAsync(Action<AppRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Integration> GetAsync(Action<AppRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<AppRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<AppRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new AppRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public class AppRequestBuilderGetRequestConfiguration {
            ...
            /// </summary>
            public AppRequestBuilderGetRequestConfiguration() {
