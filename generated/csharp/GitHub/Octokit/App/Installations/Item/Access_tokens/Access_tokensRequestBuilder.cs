...
using System;
namespace GitHub.Octokit.App.Installations.Item.Access_tokens {
    /// <summary>
...
#nullable enable
        public async Task<InstallationToken?> PostAsync(Access_tokensPostRequestBody body, Action<Access_tokensRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<InstallationToken> PostAsync(Access_tokensPostRequestBody body, Action<Access_tokensRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Access_tokensPostRequestBody body, Action<Access_tokensRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Access_tokensPostRequestBody body, Action<Access_tokensRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new Access_tokensRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class Access_tokensRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new access_tokensRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public Access_tokensRequestBuilderPostRequestConfiguration() {
