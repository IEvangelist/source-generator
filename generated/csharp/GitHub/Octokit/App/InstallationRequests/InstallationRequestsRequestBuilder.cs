...
using System;
namespace GitHub.Octokit.App.InstallationRequests {
    /// <summary>
...
#nullable enable
        public async Task<List<IntegrationInstallationRequest>?> GetAsync(Action<InstallationRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<IntegrationInstallationRequest>> GetAsync(Action<InstallationRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<InstallationRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<InstallationRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new InstallationRequestsRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public class InstallationRequestsRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public InstallationRequestsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new InstallationRequestsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new installationRequestsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public InstallationRequestsRequestBuilderGetRequestConfiguration() {
