...
using System;
namespace GitHub.Octokit.Rate_limit {
    /// <summary>
...
#nullable enable
        public async Task<RateLimitOverview?> GetAsync(Action<Rate_limitRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<RateLimitOverview> GetAsync(Action<Rate_limitRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<Rate_limitRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<Rate_limitRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new Rate_limitRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public class Rate_limitRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new rate_limitRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public Rate_limitRequestBuilderGetRequestConfiguration() {
