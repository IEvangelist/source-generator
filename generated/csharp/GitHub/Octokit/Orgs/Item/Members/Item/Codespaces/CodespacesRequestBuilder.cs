...
using GitHub.Octokit.Orgs.Item.Members.Item.Codespaces.Item;
...
using System;
namespace GitHub.Octokit.Orgs.Item.Members.Item.Codespaces {
    /// <summary>
    ...
    public class CodespacesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.members.item.codespaces.item collection</summary>
