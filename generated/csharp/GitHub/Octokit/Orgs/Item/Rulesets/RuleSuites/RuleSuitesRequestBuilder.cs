...
using GitHub.Octokit.Orgs.Item.Rulesets.RuleSuites.Item;
...
namespace GitHub.Octokit.Orgs.Item.Rulesets.RuleSuites {
    ...
    public class RuleSuitesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.rulesets.ruleSuites.item collection</summary>
