...
using GitHub.Octokit.Orgs.Item.Teams.Item.Discussions.Item.Reactions.Item;
...
namespace GitHub.Octokit.Orgs.Item.Teams.Item.Discussions.Item.Reactions {
    ...
    public class ReactionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.teams.item.discussions.item.reactions.item collection</summary>
        ...
        public ReactionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions{?content*,per_page*,page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReactionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReactionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions{?content*,per_page*,page*}", rawUrl) {
        }
        /// <summary>
