...
#nullable enable
        public async Task<Selected_teamsDeleteResponse?> DeleteAsSelected_teamsDeleteResponseAsync(Selected_teamsDeleteRequestBody body, Action<Selected_teamsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Selected_teamsDeleteResponse> DeleteAsSelected_teamsDeleteResponseAsync(Selected_teamsDeleteRequestBody body, Action<Selected_teamsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Selected_teamsResponse?> DeleteAsync(Selected_teamsDeleteRequestBody body, Action<Selected_teamsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Selected_teamsResponse> DeleteAsync(Selected_teamsDeleteRequestBody body, Action<Selected_teamsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Selected_teamsPostResponse?> PostAsSelected_teamsPostResponseAsync(Selected_teamsPostRequestBody body, Action<Selected_teamsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Selected_teamsPostResponse> PostAsSelected_teamsPostResponseAsync(Selected_teamsPostRequestBody body, Action<Selected_teamsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Selected_teamsResponse?> PostAsync(Selected_teamsPostRequestBody body, Action<Selected_teamsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Selected_teamsResponse> PostAsync(Selected_teamsPostRequestBody body, Action<Selected_teamsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(Selected_teamsDeleteRequestBody body, Action<Selected_teamsRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(Selected_teamsDeleteRequestBody body, Action<Selected_teamsRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new Selected_teamsRequestBuilderDeleteRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Selected_teamsPostRequestBody body, Action<Selected_teamsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Selected_teamsPostRequestBody body, Action<Selected_teamsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new Selected_teamsRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
        ...
        /// </summary>
        public class Selected_teamsRequestBuilderDeleteRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new selected_teamsRequestBuilderDeleteRequestConfiguration and sets the default values.
            /// </summary>
            public Selected_teamsRequestBuilderDeleteRequestConfiguration() {
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class Selected_teamsRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new selected_teamsRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public Selected_teamsRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
