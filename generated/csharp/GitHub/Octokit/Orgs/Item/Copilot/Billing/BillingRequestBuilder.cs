...
#nullable enable
        public async Task<CopilotOrganizationDetails?> GetAsync(Action<BillingRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CopilotOrganizationDetails> GetAsync(Action<BillingRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<BillingRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<BillingRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new BillingRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public class BillingRequestBuilderGetRequestConfiguration {
            ...
            /// </summary>
            public BillingRequestBuilderGetRequestConfiguration() {
