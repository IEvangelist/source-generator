...
using GitHub.Octokit.Orgs.Item.Packages.Item;
...
namespace GitHub.Octokit.Orgs.Item.Packages {
    ...
    public class PackagesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.packages.item collection</summary>
        ...
        public PackagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/packages{?package_type*,visibility*,page*,per_page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PackagesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PackagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/packages{?package_type*,visibility*,page*,per_page*}", rawUrl) {
        }
        /// <summary>
        ...
        /// API method documentation <see href="https://docs.github.com/rest/packages/packages#list-packages-for-an-organization" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<Package>?> GetAsync(Action<PackagesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<Package>> GetAsync(Action<PackagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public class PackagesRequestBuilderGetRequestConfiguration {
            ...
            public PackagesRequestBuilderGetQueryParameters QueryParameters { get; set; } = new PackagesRequestBuilderGetQueryParameters();
            /// <summary>
