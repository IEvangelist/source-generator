...
using GitHub.Octokit.Orgs.Item.Packages.Item.Item.Versions.Item;
...
namespace GitHub.Octokit.Orgs.Item.Packages.Item.Item.Versions {
    ...
    public class VersionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.packages.item.item.versions.item collection</summary>
...
#nullable enable
        public async Task<List<PackageVersion>?> GetAsync(Action<VersionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<PackageVersion>> GetAsync(Action<VersionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
