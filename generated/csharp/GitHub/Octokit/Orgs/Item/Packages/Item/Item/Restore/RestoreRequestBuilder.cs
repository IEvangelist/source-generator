...
using System;
namespace GitHub.Octokit.Orgs.Item.Packages.Item.Item.Restore {
    /// <summary>
    ...
    public class RestoreRequestBuilder : BaseRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/packages/{package_type}/{package_name}/restore{?token*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RestoreRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RestoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/packages/{package_type}/{package_name}/restore{?token*}", rawUrl) {
        }
        /// <summary>
        ...
        /// API method documentation <see href="https://docs.github.com/rest/packages/packages#restore-a-package-for-an-organization" />
        /// </summary>
...
#nullable restore
        ...
        public class RestoreRequestBuilderPostRequestConfiguration {
            ...
            public RestoreRequestBuilderPostQueryParameters QueryParameters { get; set; } = new RestoreRequestBuilderPostQueryParameters();
            /// <summary>
