...
using GitHub.Octokit.Orgs.Item.PersonalAccessTokenRequests.Item;
...
namespace GitHub.Octokit.Orgs.Item.PersonalAccessTokenRequests {
    ...
    public class PersonalAccessTokenRequestsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.personalAccessTokenRequests.item collection</summary>
...
#nullable enable
        public async Task<List<OrganizationProgrammaticAccessGrantRequest>?> GetAsync(Action<PersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<OrganizationProgrammaticAccessGrantRequest>> GetAsync(Action<PersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PersonalAccessTokenRequestsPostResponse?> PostAsPersonalAccessTokenRequestsPostResponseAsync(PersonalAccessTokenRequestsPostRequestBody body, Action<PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PersonalAccessTokenRequestsPostResponse> PostAsPersonalAccessTokenRequestsPostResponseAsync(PersonalAccessTokenRequestsPostRequestBody body, Action<PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PersonalAccessTokenRequestsResponse?> PostAsync(PersonalAccessTokenRequestsPostRequestBody body, Action<PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PersonalAccessTokenRequestsResponse> PostAsync(PersonalAccessTokenRequestsPostRequestBody body, Action<PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<PersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<PersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new PersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(PersonalAccessTokenRequestsPostRequestBody body, Action<PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(PersonalAccessTokenRequestsPostRequestBody body, Action<PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        /// </summary>
        public class PersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public PersonalAccessTokenRequestsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new PersonalAccessTokenRequestsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new personalAccessTokenRequestsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public PersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration() {
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new personalAccessTokenRequestsRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public PersonalAccessTokenRequestsRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
