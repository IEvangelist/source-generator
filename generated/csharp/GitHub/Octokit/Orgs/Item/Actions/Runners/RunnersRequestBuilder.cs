// <auto-generated/>
using GitHub.Octokit.Orgs.Item.Actions.Runners.Downloads;
using GitHub.Octokit.Orgs.Item.Actions.Runners.GenerateJitconfig;
using GitHub.Octokit.Orgs.Item.Actions.Runners.Item;
using GitHub.Octokit.Orgs.Item.Actions.Runners.RegistrationToken;
using GitHub.Octokit.Orgs.Item.Actions.Runners.RemoveToken;
...
using System;
namespace GitHub.Octokit.Orgs.Item.Actions.Runners {
    /// <summary>
    ...
    public class RunnersRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.actions.runners.item collection</summary>
