...
using GitHub.Octokit.Orgs.Item.Actions.Runners.Item.Labels.Item;
...
namespace GitHub.Octokit.Orgs.Item.Actions.Runners.Item.Labels {
    ...
    public class LabelsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.actions.runners.item.labels.item collection</summary>
