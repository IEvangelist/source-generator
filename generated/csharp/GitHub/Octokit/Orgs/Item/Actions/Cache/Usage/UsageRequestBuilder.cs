...
#nullable enable
        public async Task<ActionsCacheUsageOrgEnterprise?> GetAsync(Action<UsageRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ActionsCacheUsageOrgEnterprise> GetAsync(Action<UsageRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
