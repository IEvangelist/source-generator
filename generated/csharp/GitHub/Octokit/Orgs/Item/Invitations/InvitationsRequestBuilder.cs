...
using GitHub.Octokit.Orgs.Item.Invitations.Item;
...
namespace GitHub.Octokit.Orgs.Item.Invitations {
    ...
    public class InvitationsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the GitHub.Octokit.orgs.item.invitations.item collection</summary>
        ...
        public InvitationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/invitations{?per_page*,page*,role*,invitation_source*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InvitationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InvitationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/invitations{?per_page*,page*,role*,invitation_source*}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<OrganizationInvitation?> PostAsync(InvitationsPostRequestBody body, Action<InvitationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<OrganizationInvitation> PostAsync(InvitationsPostRequestBody body, Action<InvitationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(InvitationsPostRequestBody body, Action<InvitationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(InvitationsPostRequestBody body, Action<InvitationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
        ...
        public class InvitationsRequestBuilderGetQueryParameters {
            ...
            [Obsolete("This property is deprecated, use invitation_sourceAsGetInvitation_sourceQueryParameterType instead")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <summary>Filter invitations by their invitation source.</summary>
            [QueryParameter("invitation_source")]
            public GetInvitation_sourceQueryParameterType? InvitationSourceAsGetInvitationSourceQueryParameterType { get; set; }
